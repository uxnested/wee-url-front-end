...
export const Faq = () => {
  return (
    <>
      {" "}
      <div className="mt-[100px] lg:flex lg:flex-col lg:items-center lg:justify-center">
        ...
        <div className="flex w-fit lg:mx-[0px]  lg:mt-[80px] lg:items-center lg:justify-center lg:px-[0px]">
          <FaqDescription />
        </div>
      </div>
    </>
